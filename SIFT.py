...
class SIFT(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(20, 60, 171, 61))
        font = QtGui.QFont()
        ...
        # self.lineEdit_3.setGeometry(QtCore.QRect(10, 320, 191, 31))
        # self.lineEdit_3.setStyleSheet("background-color:rgb(255, 255, 255);")
        # self.lineEdit_3.setObjectName("lineEdit_3")
        # self.label_4 = QtWidgets.QLabel(self.widget)
        # self.label_4.setGeometry(QtCore.QRect(20, 280, 141, 31))
        # self.label_4.setStyleSheet("font: italic 14pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);")
        # self.label_4.setObjectName("label_4")
        self.pushButton_2 = QtWidgets.QPushButton(self.widget)
        self.pushButton_2.setGeometry(QtCore.QRect(10, 380, 231, 41))
        self.pushButton_2.setStyleSheet("font: italic 20pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);\n" "border-radius:20px;\n" "background-color:rgb(255, 170, 127);")
        self.pushButton_2.setObjectName("pushButton_2")
        self.label_8 = QtWidgets.QLabel(self.widget)
        self.label_8.setGeometry(QtCore.QRect(20, 450, 191, 31))
        self.label_8.setStyleSheet("font: italic 16pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);")
        self.label_8.setObjectName("label_8")
        self.label_10 = QtWidgets.QLabel(self.widget)
        self.label_10.setGeometry(QtCore.QRect(20, 160, 191, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(16)
        font.setBold(False)
        ...
        self.label_10.setStyleSheet("font: italic 16pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);")
        self.label_10.setObjectName("label_10")
        self.pushButton_3 = QtWidgets.QPushButton(self.widget)
        self.pushButton_3.setGeometry(QtCore.QRect(10, 210, 231, 41))
        self.pushButton_3.setStyleSheet("font: italic 20pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);\n" "border-radius:20px;\n" "background-color:rgb(255, 170, 127);")
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.widget)
        self.pushButton_4.setGeometry(QtCore.QRect(10, 310, 231, 41))
        self.pushButton_4.setStyleSheet("font: italic 20pt \"Times New Roman\";\n""color:rgb(255, 255, 255);\n""border-radius:20px;\n""background-color:rgb(255, 170, 127);")
        ...
        self.label_5.setGeometry(QtCore.QRect(0, 10, 341, 311))
        ...
        self.label_9.setGeometry(QtCore.QRect(350, 10, 311, 311))
        self.label_9.setStyleSheet("background-color:rgb(85, 85, 85);")
        self.label_9.setText("")
        self.label_9.setObjectName("label_9")
        self.label_7 = QtWidgets.QLabel(self.widget_2)
        self.label_7.setGeometry(QtCore.QRect(310, 330, 141, 21))
        self.label_7.setStyleSheet("font: italic 16pt \"Times New Roman\";\n" "color:rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Insert first_ Image"))
        self.pushButton.setText(_translate("MainWindow", "Browse "))
        self.pushButton.clicked.connect(self.browse_image1)
        # self.label_4.setText(_translate("MainWindow", "Matches number"))
        self.pushButton_2.setText(_translate("MainWindow", "SSD"))
        self.label_8.setText(_translate("MainWindow", "computation time"))
        self.label_10.setText(_translate("MainWindow", "Insert second_ Image"))
        self.pushButton_3.setText(_translate("MainWindow", "Browse "))
        self.pushButton_3.clicked.connect(self.browse_image2)
        self.pushButton_4.setText(_translate("MainWindow", "NCC"))
        self.label_7.setText(_translate("MainWindow", "Matching"))
        self.pushButton_4.clicked.connect(self.matching)
        self.pushButton_2.clicked.connect(self.matching)
        

    def browse_image1(self):
        image1 = QFileDialog.getOpenFileName(None, 'OpenFile', '', "Image file(*.jpg)")
        self.imagePath1 = image1[0]
        pixmap = QPixmap(self.imagePath1)
        self.label_5.setPixmap(pixmap.scaled(310, 300))

    def browse_image2(self):
        image2 = QFileDialog.getOpenFileName(None, 'OpenFile', '', "Image file(*.jpg)")
        self.imagePath2 = image2[0]
        pixmap = QPixmap(self.imagePath2)
        self.label_9.setPixmap(pixmap.scaled(310, 300))
...
###############################
    ...
    def matching(self):
        ...
        img1 = cv2.imread(self. imagePath1 ,0)
        img2 = cv2.imread(self. imagePath2 ,0)
    ...
    def ssd_ncc(self):
        img1 = cv2.imread(self. imagePath1 ,0)
        img2 = cv2.imread(self. imagePath2 ,0)
        kp1, desc1 = self.computeKeypointsAndDescriptors(img1)
        kp2, desc2 = self.computeKeypointsAndDescriptors(img2)
